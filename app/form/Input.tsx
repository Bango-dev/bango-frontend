    ...
    <div className={`flex flex-col gap-1 w-full ${className}`}>
      ...
      <div className={`relative w-full ${className}`}>
        <input
          ...
          } rounded-md text-xs sm:text-sm md:text-lg  p-2 outline-none focus:ring-2 focus:ring-[var(--primary-color)] focus:border-[var(--primary-color)] transition w-full  ${className}`}
        />
        {rightIcon && (
          <span
